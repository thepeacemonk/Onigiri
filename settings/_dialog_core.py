...
class DialogCoreMixin:
    def __init__(self, parent=None, addon_path=None, initial_page_index=0):
        ...
        saved_stats_title = mw.col.conf.get("modern_menu_statsTitle")
        self.stats_title_input = QLineEdit(saved_stats_title if saved_stats_title is not None else DEFAULTS["statsTitle"])
        ...
        # Pinned top — profile bar + search stay above the scroll area so they
        # are always visible and their width is unaffected by the scrollbar.
        sidebar_top = QWidget()
        ...
        # content — otherwise the layout spreads the leftover height as equal
        # gaps above/between/below the profile bar and search button.
    ...
    def navigate_to_page(self, page_name):
        ...
        try:
            ...
            if hasattr(self, "page_title_label"):
                ...
                self.page_title_label.setVisible(not has_custom_header)
...
class DialogCoreMixin2:
    ...
    def save_settings(self):
        ...
        try:
            ...
            # Manually save the theme's background color if the Main menu tab was never opened.
