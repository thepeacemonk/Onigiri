...
from ._widget_grid_v2 import WidgetGridEditorV2
from . import _widget_grid_v2
...
SettingsDialog.WidgetGridEditorV2 = WidgetGridEditorV2
SettingsDialog.AdaptiveModeCard = AdaptiveModeCard
SettingsDialog.ResponsiveModeCardsContainer = ResponsiveModeCardsContainer

for _m in (_infra, _page_colors, _page_themes, _page_fonts, _page_sidebar, _dialog_core, _page_sync, _page_profile, _page_mainmenu, _page_backgrounds, _page_reviewer, _page_hidemodes, _page_overviews, _page_languages, _page_gallery, _page_study_tools, _layout_base, _layout_main, _layout_sidebar, _widget_grid_v2):
