...
class PageThemesMixin:
    ...
    def _apply_theme_payload(self, theme_data: dict, *, mark_pending=False, refresh_widgets=True):
        ...
        # Keep the Sidebar and Widget Color and Effect backgrounds tied to the
        ...
        # Update Widget Color and Effect inputs (Overview page) likewise.
    ...
    def _sync_theme_export_state(self):
        ...
        # hideRetentionStars moved to the Stats Widgets section, which owns the
        # switch and writes the key in _save_stats_widgets_settings.
    ...
    def _reset_theme_media_config_to_default(self, default_colors):
        ...
        # Sidebar background mirrors Widget Color and Effect so the two stay in sync.
