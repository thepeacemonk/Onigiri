        ...
        sections = [
            (tr("profile"), tr("profile_desc"), ["Profile"],
             ...
             [s(tr("user_details"), "Profile", "user_details", ["details", "detalhes", "dados", "usuario", "usuário", "account", "conta"]),
              ...
              s(tr("profile_extras", "Avatar & Sections"), "Profile", "profile_extras", ["avatar size", "initials", "initials background", "profile sections", "section visibility"])],
            ...
            (tr("menu"), tr("menu_desc"), ["Main menu", "Sidebar"],
             [s(tr("organize"), "Main menu", "organize", ["arrange", "ordenar", "organizar"]),
              ...
              s(tr("widget_background", "Widget Background"), "Main menu", "widget_background", ["glassmorphism", "glass", "frosted", "overlay", "tint", "solid", "transparency", "widget style", "blur"]),
              s(tr("sidebar_behaviour", "Sidebar Behaviour"), "Sidebar", "sidebar_behaviour", ["collapse button", "expand button", "ellipsis", "menu button", "hover"]),
            ...
            (tr("study_pages"), tr("study_pages_desc"), ["Overviewer", "Reviewer"],
             [s(tr("overviewer_background"), "Overviewer", "overviewer_background", ["overview background", "fundo da visao geral", "fundo da visão geral"]),
              ...
              s(tr("reviewer_notifications", "Notifications"), "Reviewer", "reviewer_notifications", ["notification position", "silent notifications", "mute", "toast position"]),
