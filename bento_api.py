"""Public integration API ("Bento") for other add-ons.

External add-ons can register dashboard widgets/games with Onigiri, and query
Onigiri's version/settings entry points via ``mw.onigiri_api``.
"""
