(function () {
    ...
    const ONIGIRI_PKG = (window.ONIGIRI_CONFIG && window.ONIGIRI_CONFIG.addonPackage) || "1011095603";
    const MOCHI_ICON_IMAGE = `/_addons/${ONIGIRI_PKG}/system_files/gamification_images/mochi_messenger.webp`;
    const pendingQueue = [];
