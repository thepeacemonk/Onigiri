...
USAGE_PREFIX = """\
import importlib
favorites = importlib.import_module("1011095603.tools.favorites_cleanup")
"""
...
def remove_favorite(deck_id):
    ...
    Usage from Anki debug console (Cmd+Shift+;):
        import importlib
        favorites = importlib.import_module("1011095603.tools.favorites_cleanup")
        favorites.remove_favorite("1234567890")  # Replace with actual deck ID
