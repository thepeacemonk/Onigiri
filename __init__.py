...
def _on_webview_cmd(handled: tuple[bool, object], cmd: str, context) -> tuple[bool, object]:
    """
    Catches custom pycmd calls from the Deck Browser's webview.
    """
...
def activate_onigiri_renderer():
    """Replaces Anki's default deck browser renderer with our own."""
...
gui_hooks.main_window_did_init.append(activate_onigiri_renderer)
