"""Native icon/emoji picker dialogs (ported from upstream settings package)."""

import os
import shutil

from aqt.qt import (
    QColor, QDialog, QFileDialog, QFrame, QGraphicsColorizeEffect,
...
from .assets import svg_contain_rect, system_icon_path
